-- ====================================
-- RESTAURAR RPC ORIGINAL COM 2 FOTOS
-- Sistema igual ao que funcionava com 4
-- ====================================

-- Dropar função problemática
DROP FUNCTION IF EXISTS upload_progress_photo(TEXT, TEXT, TEXT);

-- Criar RPC que funciona como antes (mas com 2 fotos)
...
'Upload de fotos via Base64. Sistema restaurado para funcionar como antes, mas com 2 fotos (lateral e abertura). Chama Edge Function para fazer upload real.';